...
az network vnet create --resource-group myresourcegroup --name virtualnetwork --address-prefixes 10.0.0.0/16 --subnet-name mysubnet --subnet-prefix 10.0.0.0/24
...
for vm in ${vms}; do
	...
	az network nic create --resource-group myresourcegroup --name $vm-nics --vnet-name virtualnetwork --subnet mysubnet --network-security-group $vm-nsg --public-ip-address $vm-ip
